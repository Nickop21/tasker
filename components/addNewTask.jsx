  ...
  return (
    <div className="flex flex-col gap-4 md:px-14 lg:px-0">
      <h1 className="font-bold text-3xl text-[#1E2026]">
        Hey ! Their is no tommorow Finish What u left?{" "}
        <span className="text-[#6947BF]">You can do it.</span>
      </h1>

        {/* adding tasks */}
        <div className="w-full flex justify-between items-center rounded-sm border-2 p-4 border-[#D6DFE4] bg-[#FCFBFDB8] mt-6 relative overflow-hidden">
          <div className="w-[70%] h-[250px] rounded-sm border-dashed border-2 border-[#CEC4EB] p-10 bg-[#FCFBFD] flex items-center justify-center flex-col">
            <input
              type="text"
            ...
            <div className="w-full flex justify-between pt-4 ">
              ...
              <button className="px-8 py-2 text-black bg-violet-400 rounded-xl" onClick={()=>todoDataAdd()}>
                Add Task
              </button>
            </div>
          </div>
